...
object HighwayTools : PluginModule(
    ...
    val pickupDelay by setting("Pickup Delay", 35, 0..100, 1, { page == Page.STORAGE_MANAGEMENT && storageManagement }, description = "Delay ticks when pickup item from shulkerbox")
    ...
    val manageXP by setting("Manage XP", true, { page == Page.STORAGE_MANAGEMENT && storageManagement }, description = "Choose to manage XP")
    ...
    val saveXP by setting("Save XP", 1, 0..64, 1, { page == Page.STORAGE_MANAGEMENT && manageXP && storageManagement}, description = "How many XP items are saved")
    ...
    val disableMode by setting("Disable Mode", DisableMode.DISABLE, { page == Page.STORAGE_MANAGEMENT }, description = "Choose action when bot is out of materials or tools")
